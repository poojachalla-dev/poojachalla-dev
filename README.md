...
[![LeetCode](https://img.shields.io/badge/LeetCode-FFA116?style=for-the-badge&logo=leetcode&logoColor=black)](https://github.com/poojachalla-dev/leetcode)
...
|---------|-------------|--------|------|
| 🏠 **[Customer-Churn-Prediction-using-Logistics-Regression](https://github.com/poojachalla-dev/Customer-Churn-Prediction-using-Logistic-Regression)** | Developed a customer churn prediction model using Logistic Regression. Performed data preprocessing, feature engineering, exploratory analysis, and model evaluation to identify factors affecting customer retention | ✅ Complete | Python, Pandas, NumPy, Scikit-learn, Matplotlib, Seaborn |
| 🏠 **[Scikit-Learn-House Price Prediction](https://github.com/poojachalla-dev/House-Price-Prediction-ML)** | Built an end-to-end machine learning pipeline to predict house prices using regression models. Compared baseline, linear regression, and a tuned Random Forest model, achieving ~46% reduction in RMSE through hyperparameter tuning and model optimization | ✅ Complete | Python, Pandas, NumPy, Scikit-learn, Matplotlib, Seaborn |
...
⭐ *Always learning and building at the intersection of data, machine learning, and AI*

![Profile Views](https://komarev.com/ghpvc/?username=poojachalla-dev&color=blue&style=flat-square)
